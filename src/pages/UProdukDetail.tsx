  ...
  <div className="flex flex-col min-h-screen bg-[#beccfc] text-gray-800 font-semibold">
    <div className="w-full max-w-4xl mx-auto px-4 py-6 md:py-10 flex-grow">
      <button
        ...
        className="mb-4 px-4 py-2 bg-white text-[#35467e] border border-[#35467e] rounded hover:bg-[#35467e] hover:text-white transition"
      >
        ← Kembali ke Produk
      </button>
      ...
      {/* Detail Produk */}
      <div className="space-y-3 bg-white rounded-xl shadow px-4 py-5 sm:px-6 sm:py-6 mb-16">
